...
extension LastNameValidatorTests {
    ...
    func testValidate_InputGreaterThanTenCharactersInLength_ReturnFalse() {
        let validator = LastNameValidator()
        XCTAssertFalse(validator.validate(elevenCharachterName), "string can not have more than 11 characters.")
    }
    
    func testValidate_InputTwoCharactersInLength_ReturnsTrue() {
        let validator = LastNameValidator()
        XCTAssertTrue(validator.validate(twoCharachterName), "string with 2 charachters should have been valid.")
    }
    
    func testValidate_InputTenCharactersInLength_ReturnsTrue() {
        let validator = LastNameValidator()
        XCTAssertTrue(validator.validate(tenCharachterName), "string with 10 characters should have been valid.")
    }
...
//MARK: - special characters validation
extension LastNameValidatorTests {
    
    func testValidate_InputWithSingleQoute_ReturnsTrue() {
        let validator = LastNameValidator()
        XCTAssertTrue(validator.validate(nameWithSingleQuote), "string with single qoute should have been valid.")
    }
...
extension LastNameValidatorTests {
    ...
    func testValidate_InputWithDigit1_ReturnsFalse() {
        let validator = LastNameValidator()
        XCTAssertFalse(validator.validate(nameWithDigit1), "string can not have digit 0 in it.")
    }
    
    func testValidate_InputWithDigit2_ReturnsFalse() {
        let validator = LastNameValidator()
        XCTAssertFalse(validator.validate(nameWithDigit2), "string can not have digit 0 in it.")
    }
    
    func testValidate_InputWithDigit3_ReturnsFalse() {
        let validator = LastNameValidator()
        XCTAssertFalse(validator.validate(nameWithDigit3), "string can not have digit 0 in it.")
    }
    
    func testValidate_InputWithDigit4_ReturnsFalse() {
        let validator = LastNameValidator()
        XCTAssertFalse(validator.validate(nameWithDigit4), "string can not have digit 0 in it.")
    }
    
    func testValidate_InputWithDigit5_ReturnsFalse() {
        let validator = LastNameValidator()
        XCTAssertFalse(validator.validate(nameWithDigit5), "string can not have digit 0 in it.")
    }
    
    func testValidate_InputWithDigit6_ReturnsFalse() {
        let validator = LastNameValidator()
        XCTAssertFalse(validator.validate(nameWithDigit6), "string can not have digit 0 in it.")
    }
    
    func testValidate_InputWithDigit7_ReturnsFalse() {
        let validator = LastNameValidator()
        XCTAssertFalse(validator.validate(nameWithDigit7), "string can not have digit 0 in it.")
    }
    
    func testValidate_InputWithDigit8_ReturnsFalse() {
        let validator = LastNameValidator()
        XCTAssertFalse(validator.validate(nameWithDigit8), "string can not have digit 0 in it.")
    }
    
    func testValidate_InputWithDigit9_ReturnsFalse() {
        let validator = LastNameValidator()
        XCTAssertFalse(validator.validate(nameWithDigit9), "string can not have digit 0 in it.")
    }
